...
def step_MC_proteins_A_B (time_step, list_DNA, list_A, list_B, list_empty_DNA, L, E_ad, E_aa, E_ba, E_ab, residence_times, times_variables, does_B_bind, k):
    ...
    if random_event < 0.5:  
        ...
        list_DNA, list_A, random_A,list_empty_DNA,residence_time  = events_for_MC_steps.remove_A (list_DNA, list_empty_DNA, list_A , random_A, list_B, residence_times, times_variables, E_ad, E_aa, E_ab, time_step, k)
    ...
    if random_event < 0.5:  #Adding B event is selected 
        ...
        if (list_B[random_B, :] != -1).any(): #if there is at least one occupied site 
            ...
            list_A, list_B = events_for_MC_steps.remove_B_event(list_DNA, list_A, list_B,random_B, k, E_ba)
